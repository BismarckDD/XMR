...
static void Transform(groestlHashState *ctx, const uint8_t *input, int msglen)
{
...
static void Update(groestlHashState* ctx, const BitSequence* input, DataLength databitlen)
{
    int index = 0;
...
static void Final(groestlHashState* ctx, BitSequence* output)
{
